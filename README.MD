...
**Alternatively, if the high cost of metal 3d printing isn't acceptable, both part can be produced with 3d printed polycarbonate, filled with mineral oil, and sealed. The diode mount can be hot glued to the top plastic to form a seal as not to affect the beam.**
